...
#define  RF24L01_CE_0        P4OUT &=~BIT2         //CE在P42   
#define  RF24L01_CE_1        P4OUT |= BIT2        

#define  RF24L01_CSN_0       P4OUT &=~BIT1         //CS在P41
#define  RF24L01_CSN_1       P4OUT |= BIT1     

#define  RF24L01_SCK_0       P4OUT &=~BIT0         //SCK在P40
#define  RF24L01_SCK_1       P4OUT |= BIT0   

#define  RF24L01_MISO        P3IN&BIT6             //MISO在P36
#define  RF24L01_MISO_P      BIT6

#define  RF24L01_MOSI_0      P3OUT &=~BIT7         //MOSI在P37
#define  RF24L01_MOSI_1      P3OUT |= BIT7

#define  IRQDIR              P1DIR &= ~BIT3        //IRQ P13 中断引脚 下降沿
...
void init_NRF24L01(void)
{
	...
	SPI_RW_Reg(WRITE_REG + RF_SETUP, 0x07);   		//设置发射速率为1MHZ，发射功率为最大值-12dBm,关了PA 0x02
